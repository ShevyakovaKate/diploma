...
export class AnalysisService {
  ...
  public getModelWithParamenter(file: File, initParams: Parameter[], modelId: number) {
   ...
   /* formData.append("initParams", JSON.stringify([{"_name":"N_eff","_value":0.043439979976859916,"_minValue":1E-3,"_maxValue":100},
      {"_name":"f_trip","_value":0.5,"_minValue":0,"_maxValue":0.09999},
      {"_name":"tay_trip","_value":0.043439979976859916,"_minValue":10E-6,"_maxValue":1},
      {"_name":"tay_diff","_value":20.0,"_minValue":10E-3,"_maxValue":10},
      {"_name":"a","_value":0.043439979976859916,"_minValue":1.001, "_maxValue":20}]));*/
  ...
  public startAnalysis(file: File, initParams: Parameter[], modelId: number) {
   ...
   /* formData.append("initParams", JSON.stringify(
    ...
    formData.append("initParams", JSON.stringify([{"_name":"N_eff","_value":0.05,"_minValue":1E-3,"_maxValue":100},
      {"_name":"f_trip","_value":0.6,"_minValue":0,"_maxValue":0.09999},
      {"_name":"tay_trip","_value":0.5,"_minValue":10E-6,"_maxValue":1},
      {"_name":"tay_diff","_value":50.0,"_minValue":10E-3,"_maxValue":10},
      {"_name":"a","_value":3.0,"_minValue":1.001, "_maxValue":20}]));
